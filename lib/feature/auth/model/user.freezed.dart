    ...
    return _then(_value.copyWith(
      ...
      role: null == role
          ...
          : role // ignore: cast_nullable_to_non_nullable
              as String,
      completedProfile: null == completedProfile
...
class _$UserImpl implements _User {
  const _$UserImpl(
      ...
      required this.email,
      required this.role,
      @JsonKey(name: 'completed_profile') required this.completedProfile,
  ...
  @override
  String toString() {
    return 'User(userId: $userId, name: $name, email: $email, role: $role, completedProfile: $completedProfile, accessToken: $accessToken, photo: $photo)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, userId, name, email, role,
      completedProfile, accessToken, photo);
...
abstract class _User implements User {
  const factory _User(
      ...
      @JsonKey(name: 'completed_profile') required final bool completedProfile,
